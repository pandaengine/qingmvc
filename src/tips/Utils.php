...
class Utils{
	 ...
	 * @return string
	 */
	static public function getShortClassName($fullClassName){
	 ...
	 * @return string
	 */
	static public function camelString($str){
	 ...
	 * @return string
	 */
	static public function getMethodName($field,$pre=''){
	 ...
	 */
	static public function getPropName($propName){
		//只允许字母数字下划线
